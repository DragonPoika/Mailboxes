...
execute as @a[tag=!mailboxes.notifi] at @s if entity @e[type=marker,tag=mailboxes.storage,distance=..4,scores={mailboxes.itemcount=1..}] run advancement grant @s only mailboxes:survival/get_mail
