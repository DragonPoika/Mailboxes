...
execute if score #block mailboxes.settings matches 1 run execute if block ~ ~ ~ blast_furnace{Items:[{components:{"minecraft:custom_name":"Bamboo Mailbox"}}]} run loot spawn ~ ~ ~ loot mailboxes:bamboo_mailbox
execute if score #block mailboxes.settings matches 1 run execute if block ~ ~ ~ blast_furnace{Items:[{components:{"minecraft:custom_name":"Birch Mailbox"}}]} run loot spawn ~ ~ ~ loot mailboxes:birch_mailbox
execute if score #block mailboxes.settings matches 1 run execute if block ~ ~ ~ blast_furnace{Items:[{components:{"minecraft:custom_name":"Cherry Mailbox"}}]} run loot spawn ~ ~ ~ loot mailboxes:cherry_mailbox
execute if score #block mailboxes.settings matches 1 run execute if block ~ ~ ~ blast_furnace{Items:[{components:{"minecraft:custom_name":"Crimson Mailbox"}}]} run loot spawn ~ ~ ~ loot mailboxes:crimson_mailbox
execute if score #block mailboxes.settings matches 1 run execute if block ~ ~ ~ blast_furnace{Items:[{components:{"minecraft:custom_name":"Dark Oak Mailbox"}}]} run loot spawn ~ ~ ~ loot mailboxes:dark_oak_mailbox
execute if score #block mailboxes.settings matches 1 run execute if block ~ ~ ~ blast_furnace{Items:[{components:{"minecraft:custom_name":"Jungle Mailbox"}}]} run loot spawn ~ ~ ~ loot mailboxes:jungle_mailbox
execute if score #block mailboxes.settings matches 1 run execute if block ~ ~ ~ blast_furnace{Items:[{components:{"minecraft:custom_name":"Mangrove Mailbox"}}]} run loot spawn ~ ~ ~ loot mailboxes:mangrove_mailbox
execute if score #block mailboxes.settings matches 1 run execute if block ~ ~ ~ blast_furnace{Items:[{components:{"minecraft:custom_name":"Oak Mailbox"}}]} run loot spawn ~ ~ ~ loot mailboxes:oak_mailbox
execute if score #block mailboxes.settings matches 1 run execute if block ~ ~ ~ blast_furnace{Items:[{components:{"minecraft:custom_name":"Spruce Mailbox"}}]} run loot spawn ~ ~ ~ loot mailboxes:spruce_mailbox
execute if score #block mailboxes.settings matches 1 run execute if block ~ ~ ~ blast_furnace{Items:[{components:{"minecraft:custom_name":"Warped Mailbox"}}]} run loot spawn ~ ~ ~ loot mailboxes:warped_mailbox
execute if score #block mailboxes.settings matches 1 run setblock ~ ~ ~ air
scoreboard players reset #block mailboxes.settings
say 1
advancement grant @s only mailboxes:survival/placed_mailbox